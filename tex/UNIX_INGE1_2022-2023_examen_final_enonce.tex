...
\indent\textbf{A.}  Permet de ne pas aller en cours et de lancer un script le jour de l'examen \newline\hfill
\indent\textbf{B.}  Générer un document pdf d'examen à partir d'une banque de questions \newline\hfill
\indent\textbf{C.}  Faire le café \newline\hfill
\indent\textbf{D.}  Un prétexte pour faire du bash \newline\hfill
\end{document}
