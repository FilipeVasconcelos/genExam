...
\indent\textbf{A.} {\color{OliveGreen}  Générer un document pdf d'examen à partir d'une banque de questions {\large\cmark} }\newline
\indent\textbf{B.} {\color{BrickRed}    Permet de ne pas aller en cours et de lancer un script le jour de l'examen {\large\xmark} }\newline
\indent\textbf{C.} {\color{BrickRed}    Faire le café {\large\xmark} }\newline
\indent\textbf{D.} {\color{OliveGreen}  Un prétexte pour faire du bash {\large\cmark} }\newline
\question{Associer chaque script à une tâche }\\[0.0cm]
\indent\resizebox{\linewidth}{!}{%
\begin{tikzpicture}

    \node[text width=45.3969mm,align=left] (a1) at (0,0) {\textbf{ A. } \texttt{aleaQ}     };
    ...
    \node[below=0.75cm of d1.center,anchor=center,text width=118.03194mm,align = right] (d2) {\textbf{ 2. } Génère un document pdf d'examen à partir d'une banque de questions };
    ...
    \node[below=0.75cm of d2.center,anchor=center,text width=118.03194mm,align = right] (d3) {\textbf{ 3. } Renvoie la chaine de la question passée en paramètre };
    ...
    \node[below=0.75cm of d3.center,anchor=center,text width=118.03194mm,align = right] (d4) {\textbf{ 4. } Extrait la ligne des TAGS d'une question passée en paramètre };

\draw[very thick] (b3) -- (c2);
\draw[very thick] (b2) -- (c4);
\draw[very thick] (b1) -- (c1);
\draw[very thick] (b4) -- (c3);

\end{tikzpicture}
}%
\,\clearpage
\section*{Corrigé (Résumé)}
\noindent\textbf{Q.1} A. D. \newline
\textbf{Q.2} \newline
\indent\resizebox{\linewidth}{!}{%
\begin{tikzpicture}
