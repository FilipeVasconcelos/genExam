...
\begin{tikzpicture}
    ...
    \node[text width=42.37044mm,align=left] (a1) at (0,0) {\textbf{ A. } \texttt{getTAGS}     };
    ...
    \node[text width=111.97902mm,align = right] (d1) at ($(c1.east)+(6,0)$) {\textbf{ 1. } Renvoie la chaine de la question passée en paramètre };

    \node[text width=42.37044mm,below=0.75cm of a1.center,anchor=center,align=left] (a2) {\textbf{ B. } \texttt{genExam}   };
    ...
    \node[text width=42.37044mm,below=0.75cm of a2.center,anchor=center,align=left] (a3) {\textbf{ C. } \texttt{getQ}      };
    ...
    \node[below=0.75cm of d2.center,anchor=center,text width=111.97902mm,align = right] (d3) {\textbf{ 3. } Mélange les propositions d'une question passée en paramètre  };

    \node[text width=42.37044mm,below=0.75cm of a3.center,anchor=center,align=left] (a4) {\textbf{ D. } \texttt{aleaQ}     };
...
\indent\textbf{A.} {\color{BrickRed}    Permet de ne pas aller en cours et de lancer un script le jour de l'examen {\large\xmark} }\newline
