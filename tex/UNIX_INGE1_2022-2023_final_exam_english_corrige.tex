...
\begin{tikzpicture}
    ...
    \node[text width=107.43933000000001mm,align = right] (d1) at ($(c1.east)+(6,0)$) {\textbf{ 1. } Mixes the propositions of a question passed as a parameter };
    ...
    \node[below=0.75cm of d1.center,anchor=center,text width=107.43933000000001mm,align = right] (d2) {\textbf{ 2. } Generate exam pdf document from question bank };

    \node[text width=45.3969mm,below=0.75cm of a2.center,anchor=center,align=left] (a3) {\textbf{ C. } \texttt{getQ}   };
    ...
    \node[below=0.75cm of d2.center,anchor=center,text width=107.43933000000001mm,align = right] (d3) {\textbf{ 3. } Returns the question string passed as parameter };
    ...
    \node[below=0.75cm of d3.center,anchor=center,text width=107.43933000000001mm,align = right] (d4) {\textbf{ 4. } Extract the TAGS line from a question passed as a parameter };
...
\indent\textbf{A.} {\color{OliveGreen}  Generate an exam from a question bank {\large\cmark} }\newline
