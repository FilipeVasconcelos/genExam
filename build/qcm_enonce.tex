...
\indent\textbf{A.}  Un prétexte pour faire du bash \newline\hfill
\indent\textbf{B.}  Générer un document pdf d'examen à partir d'une banque de questions \newline\hfill
\indent\textbf{C.}  Permet de ne pas aller en cours et de lancer un script le jour de l'examen \newline\hfill
\indent\textbf{D.}  Faire le café \newline\hfill
\end{document}
